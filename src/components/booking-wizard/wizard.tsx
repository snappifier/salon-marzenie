// src/components/booking-wizard/wizard.tsx
"use client"
...
export function Wizard({groupedServices, staffNames, allStaffByService, initialServiceIds, prefilledCustomer, isLoggedIn}: Props) {
	...
	return (
		<div
			className="scroll-mt-20 bg-surface border border-border-subtle rounded-lg overflow-hidden shadow-sm"
			ref={wizardRef}
		>
			<header className="px-6 py-5 md:px-8 bg-surface border-b border-border-subtle">
